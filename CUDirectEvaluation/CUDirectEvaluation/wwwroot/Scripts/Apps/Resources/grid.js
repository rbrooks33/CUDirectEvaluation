...
define(['./util.js'], function (Util) {
    var Me = {
        ...
        RowActionCallback: function (callback, td) {
            ...
            var row = $($(td).parent().parent().parent().parent()[0]);
            var rowdata = unescape(row.attr("rowdata"));

            if (callback)
                callback(td, rowdata, row);
        },
            ...
            if (settings.columns) {
                ...
                if (settings.tableactions) {
                    ...
                    $.each(settings.tableactions, function (index, action) {
                        ...
                        rows += '    <a class="dropdown-item" href="#" onclick="Apps.Grids.TableActionCallback(' + action.actionclick.toString() + ');">' + action.text + '</a>';
                ...
                $.each(data, function (index, d) {
                    ...
                    if (settings.rowactions) {
                        ...
                        $.each(settings.rowactions, function (index, action) {
                            ...
                            rows += '    <a class="dropdown-item" href="#" onclick="Apps.Grids.RowActionCallback(' + action.actionclick.toString() + ',this);return false;">' + action.text + '</a>';
